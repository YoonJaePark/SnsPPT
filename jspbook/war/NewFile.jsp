...
<script type="text/javascript">
	$(".open_fancybox").click(function() {
	    ...
	    $.fancybox.open([
	        {
	            href : 'upload/img/degin1.jpg',
	            title : 'manual 1st title'
	        },
	        {
	            href : 'upload/img/degin2.jpg',
	            title : '2nd title'
	        },
	        {
	            href : 'upload/img/degin3.jpg',
	            title : '3rd title'
	        }
	    ], {
	        nextEffect : 'none',
	...
	<a class="open_fancybox" href="upload/img/degin1.jpg">
	<img src="upload/img/degin1.jpg" alt=""/>
	</a>
